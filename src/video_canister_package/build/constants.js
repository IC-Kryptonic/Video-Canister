...
exports.CANISTER_IDL_MAP = exports.CHUNK_SIZE = exports.REQUIRED_CYCLES = exports.MANAGEMENT_PRINCIPAL_ID = exports.INDEX_PRINCIPAL_ID = exports.SPAWN_PRINCIPAL_ID = void 0;
...
exports.SPAWN_PRINCIPAL_ID = DEV_MODE ? process.env.SPAWN_PRINCIPAL_ID || '' : 'ryjl3-tyaaa-aaaaa-aaaba-cai';
exports.INDEX_PRINCIPAL_ID = DEV_MODE ? process.env.INDEX_PRINCIPAL_ID || '' : 'rkp4c-7iaaa-aaaaa-aaaca-cai';
